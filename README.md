...
`app/` is the Tauri shell: a window and **109**<!--=commands--> commands, and
...
**3,198**<!--=styles-lines--> lines — no framework, three runtime dependencies,
and no fossils.

That sentence used to say *supposed to be*, and it was measured: of the
shell's **4,267**<!--=shell-lines--> lines, about 150 — 23 commands — were
