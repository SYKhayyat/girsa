...
`app/` is the Tauri shell: a window and **111**<!--=commands--> commands, and
...
**29**<!--=window-modules--> TypeScript modules and one stylesheet of
**3,287**<!--=styles-lines--> lines — no framework, three runtime dependencies.

That is a rule, not a description, and it is enforced. Of the shell's
**4,657**<!--=shell-lines--> lines, about 150 were once genuine pass-through and
