...
`app/` is the Tauri shell: a window and **122**<!--=commands--> commands, and
...
**4,028**<!--=styles-lines--> lines — no framework, three runtime dependencies.

That is a rule, not a description, and it is enforced. Of the shell's
**5,130**<!--=shell-lines--> lines, about 150 were once genuine pass-through and
