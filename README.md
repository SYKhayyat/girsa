...
`app/` is the Tauri shell: a window and **107**<!--=commands--> commands, and
...
**2,811**<!--=styles-lines--> lines — no framework, three runtime dependencies,
and no fossils.

That sentence used to say *supposed to be*, and it was measured: of the
shell's **4,006**<!--=shell-lines--> lines, about 150 — 23 commands — were
